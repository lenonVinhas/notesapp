export const pt = {
    ...
    browserStorage: 'Salvar no Navegador',
    browserStorageDesc: 'Rápido, mas limitado ao cache do navegador.',
    localFolder: 'Pasta Local',
    localFolderDesc: 'Sincronizado com uma pasta do seu computador.',
    useLocalFolder: 'Usar Pasta Local',
    changeFolder: 'Trocar Pasta',
    saveToLocalFolder: 'Salvar em Pasta Local',
    selectFolder: 'Selecionar Pasta',
    permissionNeeded: 'Permissão Necessária',
    reauthorizeAccess: 'Re-autorizar Acesso',
